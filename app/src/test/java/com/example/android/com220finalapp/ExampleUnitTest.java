...
public class ExampleUnitTest
{
    ...
    public void setBloodAlcoholTest_success()
    {
        ...
        java.sql.Timestamp time1 = java.sql.Timestamp.valueOf("2017-05-05 21:00:10");
        long timeNow = time1.getTime();

        java.sql.Timestamp ts1 = java.sql.Timestamp.valueOf("2017-05-05 10:37:10");
        java.sql.Timestamp ts2 = java.sql.Timestamp.valueOf("2017-05-05 11:00:10");
        java.sql.Timestamp ts3 = java.sql.Timestamp.valueOf("2017-05-05 11:10:10");
